...
<body>
	...
	<main>
		...
		<p class="resume">Education: In addition to his BSBA in Finance, J. Dayne has received education in various capacities from the Duke MBA program, Yale Entrepreneurial Institute, Acton Foundation for Entrepreneurial Excellence, Expositor's Seminary, and Mises Academy.</p>

		<img src="images/Logic.jpg" alt="picture of books">

		<p class="resume">Experience:  J. Dayne has worked in the business and education fields for more than 6 years in a variety of capacities.  In that time, he has worked for fortune 200 companies, millionaires, and business startups.  He has instructed and trained hundreds of students, written hundreds of pages of educational material and curriculum for various venues, and has appeared on radio, all while conquering three chronic illnesses.</p>

		<h4>RENAISSERVE?:</h4>

     	<p>Renaisserve is a word coined from the combination of renaissance and service.  A renaissance man is someone who excels in a wide range of fields.  Renaisserve is the concept of harnessing a collage of skills and abilities for greater service.  Specifically, it is employing motivation, entrepreneurship, nutrition, education, economics, lifestyle design, time-management, and innovation for the service of others.  And so it is that this site is dedicated to helping individuals maximize their capacity to serve others through pursuing excellence in these many areas.</p>

     	<p>J. Dayne loves to receive questions. Contact him now.</p>
	</main>
